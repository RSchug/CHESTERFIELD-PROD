...
//	var settingsArray = [];
//	var scriptSuffix = "CONDITION_MANAGMENT_CHESTERFIELD";
...
//				aa.print("parcel " + parcelArray[pa]["ParcelNumber"]);
//				//var layerAttributesArray = gisUtil.getGisLayerInfo(rules.gisLayer, parcelArray[pa]["ParcelNumber"], rules.mappingIdField);
//				aa.print("rules.gisField " + rules.gisField);
//				aa.print("rules.gisLayer " + rules.gisLayer);
//				aa.print("svc " + svc);
...
//					aa.print("attributes " + attibutes[at]);
//					if (aa.cap.getCapID(attibutes[at]).getOutput() != null) {
//						relatedGiScasesCaps.push(aa.cap.getCapID(attibutes[at]).getOutput());
//					}
//				}
//				//				if (layerAttributesArray != null) {
//				//					for ( var ly in layerAttributesArray) {
//				//						if (layerAttributesArray[ly].getKey().equals(rules.gisField)) {//gisField
//				//							aa.print("layerAttributesArray[ly].getKey().equals(rules.gisField) " + layerAttributesArray[ly].getValue());
//				//							if (aa.cap.getCapID(layerAttributesArray[ly].getValue()).getOutput() != null) {
//				//								relatedGiScasesCaps.push(aa.cap.getCapID(layerAttributesArray[ly].getValue()).getOutput());
//				//							}
//				//						}
//				//					}
//				//				}
...
//
//				}
//				aa.print("related caps " + relatedCaps.length);
//				cancel = true;
//				showMessage = true;
//				comment("test");
//			}
...
//						hasRecord = false;
//						for (rc in relatedCaps) {
//							aa.print("relatedCaps[rc] " + relatedCaps[rc]);
//							aa.print("parcelcapIds[pcId] " + parcelcapIds[pcId]);
...
//			showMessage = true;
//			comment("test");
//			//relatedGiScasesCaps.push(aa.cap.getCapID('BLD-CNC-17-00930').getOutput());
//
//		}
//	}
//
