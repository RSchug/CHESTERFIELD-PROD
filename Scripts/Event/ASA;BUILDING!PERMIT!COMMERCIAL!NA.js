...
if (AInfo["Nature of Work"] == "Addition"){
addFee("ADDITION","CC-BLD-COMM","FINAL",1,"Y");
addFee("STATELEVY","CC-BLD-COMM","FINAL",1,"Y")}

if (AInfo["Nature of Work"] == "Accessory Structure"){
addFee("UPFIT","CC-BLD-COMM","FINAL",1,"Y");
addFee("STATELEVY","CC-BLD-COMM","FINAL",1,"Y")}

if (AInfo["Nature of Work"] == "Administrative"){
...
if (AInfo["Nature of Work"] == "Footing and Foundation"){
...
if (AInfo["Nature of Work"] == "Interior Renovation"){
addFee("UPFIT","CC-BLD-COMM","FINAL",1,"Y");
addFee("STATELEVY","CC-BLD-COMM","FINAL",1,"Y")}

if (AInfo["Nature of Work"] == "Reroof"){
addFee("UPFIT","CC-BLD-COMM","FINAL",1,"Y");
addFee("STATELEVY","CC-BLD-COMM","FINAL",1,"Y")}
